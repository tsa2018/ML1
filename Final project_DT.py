...
dot_data = export_graphviz(clf_gini, filled=True, rounded=True, class_names=class_names, feature_names=adult.iloc[:, 1:].columns, out_file=None)
...
dot_data = export_graphviz(clf_entropy, filled=True, rounded=True, class_names=class_names, feature_names=adult.iloc[:, 1:].columns, out_file=None)
